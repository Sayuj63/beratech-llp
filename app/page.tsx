  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-ink/10">
        <div className="mx-auto grid max-w-[1400px] grid-cols-12 gap-5 px-5 pt-10 pb-14 lg:pt-16 lg:pb-24">
          {/* Left rail — meta */}
          <aside className="col-span-12 lg:col-span-2 flex lg:flex-col justify-between gap-6 lg:gap-0 lg:pt-2">
            ...
            <div className="reveal hidden lg:block mt-auto">
          ...
          <div className="col-span-12 lg:col-span-7">
            <h1 className="reveal font-display tracking-tightest leading-[0.86] text-ink text-[clamp(3.2rem,10vw,9.5rem)]">
              Beyond<br />
            ...
            <div className="reveal mt-10 max-w-xl">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <Link
                  href="/services"
                  className="group inline-flex items-center gap-3 bg-ink px-7 py-4 text-[13px] tracking-wide text-bera-cream hover:bg-bera-navy transition"
                >
                ...
                <Link
                  href="/projects"
                  className="text-[13px] tracking-wide text-ink underline underline-offset-8 decoration-bera-orange decoration-2 hover:text-bera-navy transition"
                >
                  See the work
                </Link>
              </div>
          ...
          <div className="col-span-12 lg:col-span-3 reveal reveal-slow">
          ...
          <div className="marquee-track py-5">
            {Array.from({ length: 2 }).flatMap((_, j) =>
              ['UWILD', 'NDT', 'ROV', 'Jetty Construction', 'Refinery Shutdown', 'Hull Survey', 'ADEM Coating', 'Rope Access', 'Fabrication & Installation', 'Pipeline Engineering']
                .map((w, i) => (
                  <span key={`${j}-${i}`} className="flex items-center gap-10 pr-10 font-display text-[clamp(2rem,4vw,3.5rem)] tracking-tightest whitespace-nowrap">
      ...
      <section className="border-b border-ink/10 bg-bera-cream">
        <div className="mx-auto max-w-[1400px] grid grid-cols-2 lg:grid-cols-4 divide-x divide-ink/10">
          {[
            ...
            <div key={i} className="reveal p-7 lg:p-10">
              <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-bera-orange">{c.s}</p>
              <p className="mt-3 font-display text-[clamp(2.5rem,4.5vw,4rem)] leading-none tracking-tightest text-ink lining-nums">
                {c.k}
              </p>
              <p className="mt-3 text-[13px] text-ink/60 leading-snug">{c.t}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="relative bg-bera-cream border-b border-ink/10">
        <div className="mx-auto max-w-[1400px] grid grid-cols-12 gap-10 px-5 py-20 lg:py-28">
          ...
          <div className="col-span-12 lg:col-span-8 reveal">
            <p className="font-display text-[clamp(1.5rem,2.6vw,2.4rem)] leading-snug text-ink tracking-tight">
      ...
      <section className="border-b border-ink/10 bg-ink text-bera-cream">
        <div className="mx-auto max-w-[1400px] px-5 py-20 lg:py-28">
          <div className="grid grid-cols-12 gap-6 items-end mb-14">
            ...
            <h2 className="col-span-12 lg:col-span-7 reveal font-display text-[clamp(2.2rem,5vw,4.2rem)] leading-[0.95] tracking-tightest">
              Four pillars. <span className="italic text-bera-amber">One workshop.</span>
            </h2>
            <p className="col-span-12 lg:col-span-3 reveal text-bera-cream/70 text-[14px] leading-relaxed border-l border-bera-cream/15 pl-4">
          ...
          <div className="grid gap-px bg-bera-cream/10 lg:grid-cols-2">
            {SERVICE_PILLARS.map((p) => (
              <Link
                key={p.id}
                href={`/services#${p.id}`}
                className="reveal group block bg-ink p-8 lg:p-10 hover:bg-steel transition-colors"
              >
                <div className="flex items-baseline justify-between border-b border-bera-cream/15 pb-6">
                  <div>
                    <p className="font-mono text-[11px] tracking-[0.22em] uppercase text-bera-orange">
                      Pillar {p.n}
                    </p>
                    <h3 className="mt-2 font-display text-[clamp(1.8rem,3vw,2.6rem)] leading-none tracking-tightest">
                      {p.title}
                    </h3>
                  </div>
                  <span className="text-bera-orange text-2xl group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform">↗</span>
                </div>
                <p className="mt-5 text-bera-cream/70 text-[14px] leading-relaxed">{p.note}</p>
        ...
        <div className="mx-auto max-w-[1400px] px-5 py-20 lg:py-28">
          <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
            <div className="reveal">
              ...
              <h2 className="mt-3 font-display text-[clamp(2rem,4.5vw,3.6rem)] leading-[0.95] tracking-tightest text-ink">
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 md:col-span-7 reveal">
              <div className="relative aspect-[4/3] overflow-hidden">
                <Image src="/images/projects/project-03.jpg" alt="Workshop fabrication" fill className="object-cover" sizes="(min-width: 768px) 60vw, 100vw" />
              </div>
            </div>
            <div className="col-span-12 md:col-span-5 grid grid-rows-2 gap-4">
              <div className="reveal relative aspect-[4/3] md:aspect-auto overflow-hidden">
                <Image src="/images/projects/project-01.jpg" alt="Offshore equipment" fill className="object-cover" sizes="(min-width: 768px) 40vw, 100vw" />
              </div>
              <div className="reveal relative aspect-[4/3] md:aspect-auto overflow-hidden">
                <Image src="/images/projects/project-05.jpg" alt="Heavy fabrication" fill className="object-cover" sizes="(min-width: 768px) 40vw, 100vw" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ─── CLIENTS STRIP ─── */}
      <section className="border-b border-ink/10 bg-bera-cream">
        <div className="mx-auto max-w-[1400px] grid grid-cols-12 gap-10 px-5 py-20">
          <div className="col-span-12 lg:col-span-4 reveal">
            <p className="font-mono text-[11px] tracking-[0.24em] uppercase text-bera-orange">◆ Trusted by</p>
            <h2 className="mt-3 font-display text-[clamp(2rem,4vw,3rem)] leading-[0.95] tracking-tightest text-ink">
            ...
            <Link href="/clients" className="inline-block mt-6 text-[13px] tracking-wide text-ink underline underline-offset-8 decoration-bera-orange decoration-2">
          ...
          <div className="col-span-12 lg:col-span-8 grid grid-cols-2 lg:grid-cols-4 gap-px bg-ink/10">
            {['Indian Navy', 'HCC', 'Subsea Technology', 'L&T'].map((c, i) => (
              <div key={c} className="reveal bg-bera-cream p-7 flex flex-col justify-between min-h-[180px]">
                <p className="font-mono text-[10px] tracking-widest uppercase text-bera-orange">0{i + 1}</p>
                <p className="font-display text-2xl leading-tight tracking-tight text-ink">{c}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-ink text-bera-cream">
        <div className="mx-auto max-w-[1400px] px-5 py-24 lg:py-32 grid grid-cols-12 gap-10 items-end">
          <h2 className="col-span-12 lg:col-span-8 reveal font-display tracking-tightest text-[clamp(2.5rem,7vw,6rem)] leading-[0.9]">
            Have a project where <span className="italic text-bera-amber">precision</span> is non-negotiable?
          </h2>
          <div className="col-span-12 lg:col-span-4 reveal">
            <p className="text-bera-cream/70 text-[15px] leading-relaxed mb-6">
              Tell us about scope, location and timeline. We respond within one working day.
            </p>
            <Link
              href="/contact"
              className="group inline-flex items-center gap-3 bg-bera-orange px-8 py-4 text-ink font-medium tracking-wide"
            >
              Start an enquiry
